...
class ScenicSimulator:
    ...
    def setSimulation(self, scene):
        ...
        try:
            self.simulation = self.simulator.createSimulation(scene, verbosity=self.args.verbosity, timestep=0.1, maxSteps=1000, name='scenic') #caixuan
    ...
    def runSimulation(self):
        ...
        self.simulation.currentTime = 0 #caixuan
